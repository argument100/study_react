...
var AreaInput = _react2.default.createClass({
  ...
  render: function render() {
    return _react2.default.createElement(
      "div",
      { className: "mdl-textfield mdl-js-textfield oh db" },
      ...
      _react2.default.createElement("label", { className: "mdl-textfield__label", htmlFor: "sample2" })
    );
  }
});
...
var Area = _react2.default.createClass({
  ...
  render: function render() {
    var area = this.props.data.map(function (item) {
      return _react2.default.createElement(AreaInput, { data: item });
    });
    return _react2.default.createElement(
      "div",
      null,
...
var Address = _react2.default.createClass({
  ...
  getInitialState: function getInitialState() {
    return {
      addressData: "",
      data: [{ id: "sample1", value: "", placeholder: "都道府県" }, { id: "sample2", value: "", placeholder: "市区町村" }]
    };
  },
  search: function search() {
    var _this = this;

    var add = document.getElementById('sample1').value;
    ...
    promise.then(function (resolve) {
      var reso = resolve.results[0];
      _this.setState({
        data: [{ id: "sample1", value: reso.address1, placeholder: "都道府県" }, { id: "sample2", value: reso.address2 + reso.address3, placeholder: "市区町村" }]
      });
    });
  },
  ...
  render: function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          "div",
          { className: "mdl-textfield mdl-js-textfield fl" },
          _react2.default.createElement("input", { className: "mdl-textfield__input", onChange: this.handleAddressChange, value: this.state.addressData,
            type: "text", id: "sample1", placeholder: "郵便番号" }),
          _react2.default.createElement("label", { className: "mdl-textfield__label", htmlFor: "sample1" })
        ),
        _react2.default.createElement(
          "div",
          { className: "submit" },
          _react2.default.createElement(
            "button",
            { onClick: this.search, className: "mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" },
            "検索"
          )
        )
      ),
      _react2.default.createElement(Area, { data: this.state.data })
    );
  }
});

_reactDom2.default.render(_react2.default.createElement(Address, null), document.getElementById('content'));
